...
var ANIMATION_END_NAME, ANIMATION_END_NAMES, BindShare, LoadFinished, TRANSITION_END_NAME, TRANSITION_END_NAMES, VENDORS, app, beginload, css3Prefix, debug, fShare, getList, handleFileLoad, hosts, i, loadList, mTestElement, my, preload, refreshShare, reloadWechat, shareFriend, shareTimeline, _Progress, _finishedlist, _i, _len, _list, _share_img, _share_link, _tempH, _wechat, _wechat_bool, _wechat_f;
...
_list = [
  {
    ...
    img: "10",
    name: "Them",
    author: "The Original Hit Gloria",
    year: "1965",
    answer: "错",
    hide: false
  }, {
    ...
    img: "12",
    name: "The Shaggs",
    author: "Philosophy of the World",
    year: "1969",
    answer: "对",
    hide: false
  }, {
    img: "13",
    name: "Gene Vincent and the Blue Caps",
    author: "Gene Vincent and the Blue Caps",
    year: "1967",
    answer: "错",
    hide: false
  }, {
    ...
    img: "15",
    name: "King Crimson",
    author: "In the Court of the King Crimson",
    year: "1969",
    answer: "错",
    hide: false
  }, {
    ...
    author: "Sorry Ma, Forgot to Take Out The Trash",
    year: "1981",
    answer: "对",
    hide: false
  }, {
    ...
    img: "33",
    name: "AC/DC",
    author: "For Those About to Rock ",
    year: "1981",
    answer: "对",
    hide: false
  }, {
    ...
    img: "35",
    name: "The Beatles",
    author: "We're Only in it for the Money",
    year: "1968",
    answer: "错",
    hide: false
  }, {
    ...
    img: "40",
    name: "Guns N' Roses",
    author: "Appetite For Destruction",
    year: "1987",
    answer: "对",
    hide: false
  }, {
...
app.controller('MainController', function($rootScope, $scope, $location, $timeout) {
  ...
  if ($("body").width() > 768) {
    return $rootScope.shoplink = "http://item.jd.com/1071850.html";
  } else {
    return $rootScope.shoplink = "http://item.m.jd.com/ware/view.action?wareId=1071850";
  }
});

app.controller('HomeController', function($rootScope, $scope, $location, $timeout) {
  var tis;
  this.pop = false;
  tis = this;
  this.go = function() {
    $rootScope.question = true;
    return $location.path("/question");
  };
  return this.showpop = function() {
    tis.pop = true;
...
app.controller('QuestionController', function($rootScope, $scope, $location, $timeout, $route) {
  var first, randomRm, tis;
  ...
  this.selectAnswer = function(answer) {
    var q;
    q = tis.list[tis.Now];
    if (answer && q.answer === "对") {
      console.log("答对了");
      tis.right++;
    } else if (!answer && q.answer === "错") {
      console.log("答对了");
      tis.right++;
    } else {
      console.log("答错了");
    ...
    if (tis.Now >= 10) {
      ...
      return refreshShare(tis.shareText);
    } else {
      tis.list.push(randomRm());
      return console.log(tis.list);
    }
  };
  this.re = function() {
    return $route.reload();
  ...
  this.showpop = function() {
    if ($("body").width() > 640) {
      ...
      return setTimeout(function() {
        return BindShare(tis.shareText, _share_link, _share_img);
      });
    } else {
      return tis.wechatnote = true;
    }
  };
  this.close = function() {
    if (!tis.shares) {
      return tis.shares = true;
    }
    return tis.pop = false;
  };
  this.showWechat = function() {
    return tis.shares = false;
  };
  return this.hideWechatnote = function() {
    return tis.wechatnote = false;
  };
});

app.controller('MenuController', function($rootScope, $scope, $location, $timeout) {
  var tis;
  tis = this;
  return this.menushow = function() {
    if (tis.type != null) {
      return tis.type = null;
    } else {
      return tis.type = "open";
    }
  };
});

app.directive('soundCtrl', function() {
  return {
    restrict: 'EA',
    link: function(scope, elem, attrs) {
      var audio;
      audio = document.createElement("audio");
      if (attrs.preload != null) {
        audio.preload = attrs.preload;
      }
      if (attrs.autoplay != null) {
        audio.autoplay = attrs.autoplay;
      }
      if (attrs.src != null) {
        audio.src = attrs.src;
      }
      ...
      audio.addEventListener("pause", function() {
        ...
        return scope.$apply(function() {
          return scope.soundclass = "off";
        });
      });
      return audio.addEventListener("play", function() {
        console.log("开始播放");
        return scope.$apply(function() {
          return scope.soundclass = "on";
        });
      });
    }
  };
