...
init = function() {
  ...
  if (date >= 0 && date < 8) {
    return createAnimal(0);
  } else if (date >= 8 && date < 12) {
    return createAnimal(1);
  } else if (date >= 12 && date < 16) {
    return createAnimal(2);
  } else if (date >= 16 && date < 20) {
    return createAnimal(3);
  } else {
...
selectType = function(e) {
  ...
  return $("#slidermini span").eq(e - 1).addClass('on');
};
  ...
  return $.ajax({
    ...
    success: function(msg) {
      ...
      if (msg.state === 'success') {
        return window.location.href = 'share.php?id=' + msg.id;
      } else {
