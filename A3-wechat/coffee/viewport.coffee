adaptUILayout = (()->
	...
	adapt = (uiWidth)->
		...
		initialContent   = if isiOS or isAndroidUp then 'target-densitydpi=device-dpi, width=' + uiWidth + 'px, ' + userscalable else 'target-densitydpi=' + targetDensitydpi + ', width=device-width, ' + userscalable
