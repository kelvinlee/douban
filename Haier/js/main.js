...
$(document).ready(function() {
  ...
  return $(".ctrl").each(function() {
    ...
    $(this).find(".left").click(function() {
      return moveTouchRight($ep.next());
    });
    return $(this).find(".right").click(function() {
      console.log("bb");
...
endTouch = function(e) {
  ...
  return console.log($ep.parent().next());
};

moveTouchLeft = function(ep) {
  var e, l, move, n;
  e = ep.find(".pics-list");
  e.addClass('animate');
  move = e.attr('move');
  ...
  return e.parent().next().find("span").eq(n).addClass('on');
};

moveTouchRight = function(ep) {
  var e, l, move, n;
  e = ep.find(".pics-list");
  e.addClass('animate');
  move = e.attr('move');
