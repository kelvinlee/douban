...
var calNumber, fGetCarType, fGetCarTypeHTML, fGetCarTypeHTMLS, fGetCarTypeSecond, fGetCity, fGetCityAll, fGetCityShop, fGetHTMLC, fGetHTMLP, fGetHTMLS, fGetProvince, _car_type, _pc;
...
fGetHTMLS = function(p, c) {
  ...
  for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    s = _ref[_i];
    html += '<option value="' + s.name + '" data-adr="' + s.adr + '">' + s.name + '</option>';
  }
  return html;
};
